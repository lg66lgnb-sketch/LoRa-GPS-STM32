...
uint8_t lora_rx_byte;                 // 接收单个字符的缓存
volatile char lora_recv_msg[100] = {0}; // 在 Live Watch 观察收到的完整消息
uint16_t lora_rx_index = 0;           // 接收消息的索引
...
double peer_latitude = 0.0;     // 收到的对方纬度
double peer_longitude = 0.0;    // 收到的对方经度
float peer_speed_kmh = 0.0f;    // 收到的对方速度
double peer_distance = 0.0;     // 相对对方的距离 (米)
double peer_bearing = 0.0;      // 相对对方的方位角 (度)
/* USER CODE END PV */
